...
if page == 'Data Analysis':
    ...
    image1 = Image.open('Aircraft_Pics/airimg.jpg')
    st.image(image1)
    ...
    st.write("Click on each parameter to explore more")

    with st.expander("Airlines"):
         ...
         image3 = Image.open('Aircraft_Pics/Airline.PNG')
         st.image(image3)
    ...
    with st.expander("Duration"):
         ...
         image4 = Image.open('Aircraft_Pics/Duration.PNG')
         st.image(image4)
    ...
    with st.expander("Total Stops"):
         ...
         image5 = Image.open('Aircraft_Pics/Total_stops.PNG')
         st.image(image5)
    ...
    with st.expander("Source"):
         ...
         image6 = Image.open('Aircraft_Pics/Source.PNG')
         st.image(image6)  
    ...
    with st.expander("Destination"):
         ...
         image7 = Image.open('Aircraft_Pics/Destination.PNG')
         st.image(image7)  

    with st.expander("Journey Date"):
         ...
         image8 = Image.open('Aircraft_Pics/Journey.PNG')
         st.image(image8) 
...
if page == 'Predict the Price': 
    ...
    image2 = Image.open('Aircraft_Pics/predict.jpg')
    st.image(image2)
    st.markdown("Select from the below attributes to get an estimate of your flight price.")
    Airline=st.selectbox('Airline: The name of the airline', ['Jet Airways','IndiGo','Air India','Multiple carriers','SpiceJet','Vistara','Air Asia','GoAir'])
